The data files are a bunch of csv files with either lists of songs with rated values (1-5), movies, and movies with rated values (1-5) that I used during my unit testing.
